...
import net.cabrel.ecommerceafrologix.util.FileUtil;
import net.cabrel.ecommerceafrologix.validator.ProductValidator;
...
public class ManagementController {
	...
	public ModelAndView manageProduct(@RequestParam(name="success",required=false)String success) {		
		...
		mv.addObject("title","Gestion des produits");		
	...
	public String managePostProduct(@Valid @ModelAttribute("product") Product mProduct, 
		...
		if(results.hasErrors()) {
			model.addAttribute("message", "La validation a échoue pour l'ajout du produit!");
	...
	public String managePostProductActivation(@PathVariable int id) {		
		...
		return (isActive)? "Produit désactivé avec succès! ":" Produit activé avec succès";
	}
