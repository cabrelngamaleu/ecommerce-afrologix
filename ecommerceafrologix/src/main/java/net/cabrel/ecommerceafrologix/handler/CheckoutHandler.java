...
import net.cabrel.ecommerceafrologix.model.CheckoutModel;
import net.cabrel.ecommerceafrologix.model.UserModel;
import net.cabrel.shoppingbackend.dao.CartLineDAO;
...
import net.cabrel.shoppingbackend.dto.CartLine;
import net.cabrel.shoppingbackend.dto.OrderDetail;
import net.cabrel.shoppingbackend.dto.OrderItem;
...
public class CheckoutHandler {
	...
	public CheckoutModel init(String name) throws Exception{
		...
		if(user!=null) {
			...
			if(cartLines.size() == 0 ) {
				throw new Exception("Il n'y a aucun produit disponible pour le paiement maintenant!");
			}
